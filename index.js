...
const find1 = _ => hasLen(2), find4 = _ => hasLen(4),
      find7 = _ => hasLen(3), find8 = _ => hasLen(7),
      find3 = m => R.allPass([hasLen(5), R.o(hasLen(2), R.intersection(m[1]))]),
      find9 = m => R.o(hasLen(5), R.intersection(m[3])),
      find0 = m => R.allPass([hasLen(6), R.o(hasLen(2), R.intersection(m[1]))]),
      find6 = _ => hasLen(6),
      find5 = m => R.o(hasLen(5), R.intersection(m[6])),
      find2 = _ => R.T;

const searchers = [[find1, 1], [find4, 4], [find7, 7], [find8, 8], [find3, 3], [find9, 9], [find0, 0], [find6, 6], [find5, 5], [find2, 2]];
...
const decode = displayed => {
  var mapping = {};
  for (var i = 0; i < R.length(searchers); i++) {
